...
updatespecies <- new2019assess %>%
  filter(str_detect(Entity.Name, c("redfish|halibut|herring|Sea Scallop|surfclam|wolffish|Butterfish|Longfin squid|Pout|quahog|Red Hake|Silver hake|Windowpane flounder|Winter flounder"
                                   )))

new2020assess <- new2019assess %>%
