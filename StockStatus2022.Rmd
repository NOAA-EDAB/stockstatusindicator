...
American plaice, Atlantic bluefish, Atlantic halibut, Atlantic herring, Atlantic wolffish, Butterfish, Haddock (3 stocks), Monkfish (2 stocks), Ocean Pout, Pollock, Shortfin squid, Spiny dogfish, White hake, Winter flounder (3 stocks), Witch flounder, and Yellowtail flounder (2 stocks)
...
Aplaice <- as.data.frame(Entity.Name = "`American plaice - Gulf of Maine / Georges Bank`",
...
bluefish <- as.data.frame(Entity.Name = "`Bluefish - Atlantic Coast`",
                          Assessment.Year = 2022,
                          `Estimated F` = 0.166,
                          Fmsy = 0.248,
                          `Estimated B` = 55344,
...
Ahalibut <- as.data.frame(Entity.Name = "`Atlantic halibut - Northwestern Atlantic Coast`",
                          Assessment.Year = 2022,
                          `Estimated F` = NA,
                          Fmsy = NA,
                          `Estimated B` = NA,
...
Aherring <- as.data.frame(Entity.Name = "`Atlantic herring - Northwestern Atlantic Coast`",
                          Assessment.Year = 2022,
...
Awolf<- as.data.frame(Entity.Name = "`Atlantic wolffish - Gulf of Maine / Georges Bank`",
                      Assessment.Year = 2022,
                      `Estimated F` = 0.004,
                      Fmsy = 0.192,
                      `Estimated B` = 690,
...
#Haddock (3 stocks), 
haddock1 <- as.data.frame(Entity.Name = "`Haddock - Eastern Georges Bank`",
                          Assessment.Year = 2022,
                          `Estimated F` = ,
                          Fmsy = ,
                          `Estimated B` = ,
...
haddock2 <- as.data.frame(Entity.Name = "`Haddock - Georges Bank`",
                          Assessment.Year = 2022,
                          `Estimated F` = 0.137,
                          Fmsy = 0.25,
                          `Estimated B` = 79513,
...
haddock3 <- as.data.frame(Entity.Name = "`Haddock - Gulf of Maine`",
                          Assessment.Year = 2022,
                          `Estimated F` = 0.375,
                          Fmsy = 0.338,
                          `Estimated B` = 16528,
...
monk1 <- as.data.frame(Entity.Name = "`Goosefish - Gulf of Maine / Northern Georges Bank`",
                       Assessment.Year = 2022,
                       `Estimated F` = NA,
                       Fmsy = NA,
                       `Estimated B` = NA,
...
monk2 <- as.data.frame(Entity.Name = "`Goosefish - Southern Georges Bank / Mid-Atlantic`",
                       Assessment.Year = 2022,
                       `Estimated F` = NA,
                       Fmsy = NA,
                       `Estimated B` = NA,
...
opout <- as.data.frame(Entity.Name = "`Ocean pout - Northwestern Atlantic Coast`",
                       Assessment.Year = 2022,
                       `Estimated F` = 0.234,
                       Fmsy = 0.76,
                       `Estimated B` = 0.263,
...
pollock <- as.data.frame(Entity.Name = "`Pollock - Gulf of Maine / Georges Bank`",
                         Assessment.Year = 2022,
...
#Shortfin squid, 
illex <- as.data.frame(Entity.Name = "`Northern shortfin squid - Northwestern Atlantic Coast`",
                       Assessment.Year = 2022,
                       `Estimated F` = ,
                       Fmsy = ,
                       `Estimated B` = ,
...
#Spiny dogfish, 
dogfish <- as.data.frame(Entity.Name = "`Spiny dogfish - Atlantic Coast`",
                         Assessment.Year = 2022,
                         `Estimated F` = ,
                         Fmsy = ,
                         `Estimated B` = ,
...
#White hake, 
whake <- as.data.frame(Entity.Name = "`White hake - Gulf of Maine / Georges Bank`",
                       Assessment.Year = 2022,
                       `Estimated F` = ,
                       Fmsy = ,
                       `Estimated B` = ,
...
wflounder1 <- as.data.frame(Entity.Name = "`Winter flounder - Georges Bank`",
                            Assessment.Year = 2022,
                            `Estimated F` = ,
                            Fmsy = ,
                            `Estimated B` = ,
...
wflounder2 <- as.data.frame(Entity.Name = "`Winter flounder - Gulf of Maine`",
                            Assessment.Year = 2022,
                            `Estimated F` = ,
                            Fmsy = ,
                            `Estimated B` = ,
...
wflounder3 <- as.data.frame(Entity.Name = "`Winter flounder - Southern New England / Mid-Atlantic`",
                            Assessment.Year = 2022,
                            `Estimated F` = ,
                            Fmsy = ,
                            `Estimated B` = ,
...
#Witch flounder, and 
witch <- as.data.frame(Entity.Name = "`Witch flounder - Northwestern Atlantic Coast`",
                       Assessment.Year = 2022,
                       `Estimated F` = ,
                       Fmsy = ,
                       `Estimated B` = ,
...
yelltail1 <- as.data.frame(Entity.Name = "`Yellowtail flounder - Cape Cod / Gulf of Maine`",
                           Assessment.Year = 2022,
                           `Estimated F` = ,
                           Fmsy = ,
                           `Estimated B` = ,
...
yelltail2 <- as.data.frame(Entity.Name = "`Yellowtail flounder - Southern New England / Mid-Atlantic`",
                           Assessment.Year = 2022,
                           `Estimated F` = ,
                           Fmsy = ,
                           `Estimated B` = ,
